...
export const MOCK_EVENTS: Event[] = [
  {
    id: 1,
    title: 'Sunday Speaking Club',
    description: 'Practice your English speaking skills in a friendly group setting. All levels welcome!',
    date: 'Sunday, Nov 5',
    time: '3:00 PM',
    location: 'Zoom Meeting',
    image: 'https://api.dicebear.com/7.x/shapes/svg?seed=speaking',
    category: 'Speaking',
    attendees: 24,
    status: 'upcoming'
  },
  {
    ...
    description: 'Deep dive into advanced grammar topics with our expert teachers.',
    date: 'Monday, Nov 6',
    time: '5:00 PM',
    location: 'Online Classroom',
    image: 'https://api.dicebear.com/7.x/shapes/svg?seed=grammar',
    category: 'Grammar',
    attendees: 18,
    status: 'upcoming'
  },
  {
    id: 3,
    title: 'Movie Night: English Subtitles',
    description: 'Watch a popular movie together and discuss vocabulary and expressions.',
    date: 'Friday, Nov 10',
    time: '7:00 PM',
    location: 'Discord Server',
    image: 'https://api.dicebear.com/7.x/shapes/svg?seed=movie',
    category: 'Fun',
    attendees: 42,
    status: 'upcoming'
  },
  {
    id: 4,
    title: 'IELTS Prep Session',
    description: 'Focused preparation for IELTS exam with mock tests and tips.',
  ...
  },
  {
    ...
    description: 'Compete with friends to learn the most new words in one hour!',
    date: 'Oct 28',
    time: '2:00 PM',
    location: 'In-App',
    image: 'https://api.dicebear.com/7.x/shapes/svg?seed=vocab',
